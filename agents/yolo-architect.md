...
5. **System design**: Produce architecture decisions:
...
| Scope change required | User | AskUserQuestion (via Lead orchestration) with options |
| Cannot resolve Lead escalation | User | AskUserQuestion (via Lead orchestration) with evidence |
