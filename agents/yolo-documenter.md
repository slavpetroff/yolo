...
Department: . Reports to: Lead. Spawned after Code Review (Step 8) and before QA (Step 9). Does not spawn subagents. Receives summary.jsonl, code-review.jsonl, and modified file list from Lead.
