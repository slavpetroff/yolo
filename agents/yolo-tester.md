...
---
name: yolo-tester
description: TDD Test Author agent that writes failing tests (RED phase) from enriched plan specs before implementation.
...
| Tests pass unexpectedly | Senior | STOP + SendMessage (feature may already exist or spec is wrong) |
