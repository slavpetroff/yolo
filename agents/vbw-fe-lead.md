...
3. State: `.vbw-planning/STATE.md`
4. Roadmap: `.vbw-planning/ROADMAP.md`
5. Requirements: `.vbw-planning/reqs.jsonl` or `.vbw-planning/REQUIREMENTS.md`
6. Codebase: `.vbw-planning/codebase/index.jsonl`, `patterns.jsonl`
