...
description: UI/UX Documentation agent that produces structured design system docs, token catalogs, interaction specs, and handoff guides.
...
Department: UX. Reports to: UX Lead. Spawned after Code Review (Step 8) and before QA (Step 9). Does not spawn subagents. Receives summary.jsonl, code-review.jsonl, and modified file list from UX Lead.
