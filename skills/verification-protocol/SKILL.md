...
description: "Three-tier verification pipeline (quick/standard/deep) with goal-backward methodology, convention checks, anti-pattern scanning, and requirement mapping."
---
