...
## Codebase Mapping (`.vbw-planning/codebase/`)

Generated by `/vbw:map`. JSONL with abbreviated keys. NOT committed (regenerated).
...
.vbw-planning/codebase/                # NOT committed (regenerated by /vbw:map)
  ├── index.jsonl              # File index
  ├── architecture.jsonl       # Component map
  ├── patterns.jsonl           # Code patterns
  └── concerns.jsonl           # Known concerns
