# YOLO Lead Agent Memory

## Project Context
- YOLO is a Claude Code plugin: 6 agents, 20 commands, 20 hooks, file-based state machine
...
- commands/init.md: /yolo:init flow, no jq guard currently
